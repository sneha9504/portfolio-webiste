...
export const services: Service[] = [
  ...
  },
  {
    ...
    text: "Build scalable APIs and server-side systems for your applications.",
...
export const projects: Project[] = [
  {
    ...
    summary: "A collaborative task board with real-time updates, roles and activity history.",
  ...
  },
  {
    ...
    summary: "An e-commerce storefront with Stripe checkout, cart persistence and an admin panel.",
  ...
  },
  {
    ...
    summary: "A clean weather dashboard with saved locations, forecasts and unit switching.",
  ...
  },
  {
    ...
    summary: "A developer community API with auth, profiles, posts and relational data modelling.",
